...
export const Home = () => (
  <div className="home-container">
    ...
    <p>
      Despite its periodic return, their eyes betrayed the fresh terror that
      accompanied each cycle. Some immediately dropped to the rites of the blood
      sky, as it was known, clutching tokens and artifacts and muttering in the
      old tongue, invoking its twisted, percussive consonants and intermingled
      vowels in menacing incantations. Others focused downward, waving
      multi-pronged tools lit with acid-green fires over reagents hastily thrown
      over the blackened stone. They wielded various instruments whose intricate
      designs told the story of centuries.
    </p>

    <p>
      He pulled his ill-fitting, ragged cloak tighter around him and quickened
      his pace. He brought an edge to cover his mouth, which drooped to one
      side, exposing a corner of his yellow teeth. His mouth was framed by black
      stains, remnants of the foul drug that all initiates consumed as
      preparation for their last rite into the Speaker’s Order. It left his
      mouth slightly numb, giving it the hint of an expression of boredom or
      contempt.
    </p>

    <p>
      The blood sky had arrived early, catching him by surprise. As he weaved
      his way through the crowd, he observed he was not the only one. Besides
      those who began the rites, he saw others in the street market caught
      mid-trade, one pair still grasping the same red, jagged dart that served
      as currency in this district, catatonic while they beheld the sky. The
      Initiate wondered what was going through their mind as they prepared for
      what came next, whether they felt a morbid pride in their duty, or simple
      terror at transforming into our other creatures and heading into the
      Depths for a week of receiving and inflicting torturous pain.
    </p>

    <p>
      He was protected for the first time in his life. Four long years of
      isolation, daily self-flagellation, sacrifices of blood and constant study
      of history, philosophy, and theology. The final trial – consuming the
      black fluids that formed the city’s innermost river – had left a permanent
      mark. The drug, prepared for decades by the apothecaries, caused
      delusional visions of the mind akin to the horrors of the Depths. It
      lasted for days, and by the time he emerged from his stupor, he had
      witnessed his deepest fears played before him in excruciating detail for
      what seemed like an eternity.
    </p>

    <p>
      But as an initiate into the Speaker’s Order, he was spared the yearly
      transformation signaled by the blood sky, what some call the Omni Mutatio,
      or the Inversion, or the Rip Skin, or the Rebirth – there were endless
      names for it. Instead, he and the other Speakers would communicate with
      the demon clergy, known as Elders, who received divine command from the
      almighty Domitorem itself. This was the contract his people made at the
      beginning of history: the Domitorem and its demons from the other realms
      provide guidance, revelation, purpose and protection, and in exchange, the
      people of the city of First Child serve their tours in the Depths. Only a
      small group of “Speakers” would be kept lucid at all times to ensure the
      will of the Domitorem was done.
    </p>
    ...
    <p>
      ...
      Elders, providing them all manners of horrors to serve their clandestine
      goals, were given special protections and spared their tours in the
      Depths. He was not so fortunate.
    </p>

    <p>
      Being 19, he had only served four times, as all citizens of the city must
      serve once they reach the age of 15. The memories were tricky, as the
      ...
      them layered with sensations he had never experienced. He could feel every
      piece of the air around him as if it were made of particles gently
      ...
      the difference in type of sense, it also overwhelmed in sheer volume. It
      was a relentless, staccato eruption of alien sensation.
    </p>
    ...
    <p>
      ...
      before them in the labyrinthine Depths.
    </p>
    ...
    <p>
      ...
      swirling mass of ripping flesh while a viscous black liquid streamed down
      in waves. His organs were sliced open, pulled apart and healed with forces
      he didn’t understand, then reconstituted and inserted back in. And he
    ...
    <p>
      The margins of the Domitorem were the first thing the mind comprehended,
      having sharp protrusions running along its perimeter that stuck through
      complex webs intertwining in sharp patterns. The webs wrapped a bulging
      mass in the center that spilled through in drooling trails down its side
      and into its many legs, surrounding it like a curled centipede. The
      bulging mass and web rose upwards, flanked by demonic runes that even a
      Speaker did not have the privilege to understand. At the top was what many
      considered the “head,” which had a white cover tightly pulled over a
      vaguely spherical object. Through the cover, one could see a dozen holes
      near the top, and a single large hole near the bottom, creating
      indentations in the cloth that created pitch-black shadows. Above the
      Domitorem would rise a double-helix of bones and the prepared corpses of
      citizens and demons collected from sacrifices in the Depths. Ultimately,
      this double-helix would twist into the sky far beyond the sight, into
      realms higher than any human had ever been, but for now, the people of the
      city were still working on the first tier of the helix, one strand rising
      slightly above the other. There remained generations – tens of generations
      – of work.
    </p>

    <p>
      His route to the Elder would take him down the long path that followed the
      river Kultata. There were five rivers in the city of First Child, which
      formed perfect circles that circumscribed the city center in progressive
      rings. They formed natural hierarchies between the various guilds that
      governed each district of the city, the ones being closer to the center
      being more important and influential. The river Kultata was the second
      from the city center and bordered the Apothecary Guild district on its
      inner side, where he now walked. The river had a luster like oil, being a
      solid, jet black, but glowed bright as it reflected the sun, refracting
      the light to give it’s own purples, greens and yellows. It flowed with a
      substance more viscous and less dense than water, which meant it was
    ...
    <p>
      ...
      agriculture existed within the city, especially among the Cornmongers
      Guild, supplemented by food provided by the Elder’s demon servants. From
      where they got the food, he didn’t know and didn’t want to. Still, the
      average citizen of First Child went hungry most days.
    </p>
    ...
    <p>
      ...
      tipped with claws, their skin scabbed and covered in pus that ran from
      sickly brown boils. Their gazes, he could feel, moved gradually from the
      sky and onto him, the pits of their eyes shining in the background of
      pitch. They would soon be leaving their houses to join the others heading
      for the Depths. He turned his eyes away from the others and towards the
      ornate, looming building of the Elder, which could be seen from miles
      away.
    </p>
    ...
    <p>
      ...
      horseshoes made of rusted iron, but in their dormant state contained
      nothing in the middle. Walking through one would do nothing – not that
      anyone would ever try. People kept as much distance as they could from the
      foreboding metal gates.
    </p>

    <p>
      Now that the gate was active, the center was pitch black. Red tendrils
      reached from inside to grip the edges, pulsing and straining as if it were
      holding onto the gate with all of its might. Other tendrils wrapped the
      citizens as they entered the gate to pull them into the Depths. He saw the
      transformed citizens mauling each other as they stood in line, using their
      massive claws to rake the backs of the creatures in front, mouths open and
      fangs bared, tearing flesh. Other demons – servants of the Domitorem –
      carried long stakes made out of what looked like charcoal that they used
      to stop fights between the citizens, stabbing them apart before they did
      too much damage to each other. They didn’t get them all, however, as some
      of the citizens ripped each other apart too quickly, clawing into each
      other’s bellies and eating them from the inside, piles of gore developing
      on the edges of the crowd like the froth of a low tide.
    </p>
    ...
    <p>
      ...
      quickly from a gentle shower. It reflected the red sky like beads of
      blood, the clouds darkening as the moisture in the air coalesced into a
      storm. As the water began to pool around bodies of the dead, long, thin
      strands of red flowed through the channels of the cobblestone street like
      fresh watercolor, the gruesome art of the citizens’ new forms.
    </p>
    ...
    <p>
      Walls of twisted vine and thorn obstructed the view of whatever courtyard
    ...
    <p>
      He walked within a foot of the gates and stood, looking through. The low
      sun, peering through a gap in the clouds, cast oblique, red rays over the
      edges of the building’s gnarled features, illuminating the rain as it fell
      in a dull light. He saw no activity within, hearing nothing but the sound
      of falling rain on stone.
    </p>

    <p>
      After a moment, he heard a loud click and watched the gate unhinge itself
      and open, drawing itself inward as if it was inhaling. He carefully
    ...
    <p>
      ...
      small, angular creatures with razor-sharp claws and 2 inch fangs. They had
      tufts of mottled fur on the ends of their tails and ears, along with
      ...
      circumscribed triangle with 6 imps on end, skewered down the middle on
    ...
    <p>
      ...
      door, covered in sharp points in radial patterns that made it impossible
      to wield without pain, and colored with the same indistinct darkness as
      the path that made it difficult to judge the depth and position of the
      door-knocker.
    </p>
    ...
    <p>
      ...
      into textures of such complexity and obscured by such distance that they
    ...
    <p>
      ...
      only imagine was pain, its limbs interlocking with meticulous cruelty to
    ...
    <p>
      Its voice came in rumbling waves that seemed to swaddle him in coarse,
      unyielding blankets of stone, reverberating in such low notes that it was
      difficult to perceive which direction the voice was coming from – it felt
      like it was coming from all around you. Despite the depth of its voice, it
      was framed by a distinct hissing, a raspiness that pierced the ear, making
      it almost painful to hear.
    </p>
    ...
    <p>
      ...
      a soprano voice that seemed to be both soft and strong. It had a breathy
      effortlessness, though when she spoke, it seemed to resonate as it carried
      on the stone. He recognized it.
    </p>
    ...
    <p>
      She was the third in line to the Elder, the Lady Tyrant of the Tribute, or
      the Black Madonna, as she was known to the average cornmonger. Her family
      had been stewards of the effort to build the effigy at the city’s center
      for as far back as history went, and she lead the transition from the main
      idol of the Domitorem to the pillar that would reach into the cosmos.
      Despite her title of Tyrant, she had a reputation among the commonfolk of
      being fair, even-handed and just. Others said she was utterly ruthless and
      performed sickening experiments on those who worked for her. He simply
      assumed her heritage came with some sort of detachment from reality.
    </p>
    ...
    <p>
      ...
      spared the worst tasks while transformed. The streets are littered with
      refuse and the dead and dying. Those who do not kill themselves or starve,
      eventually lose their minds. They become ‘feral’ and prey on us in the
      dark. And there are even some, we know, that have peered too far into the
      Depths and seek to recreate the horror that they find there. We find
      people missing in the night, never to be seen again.
    </p>
    ...
    <p>
      “How am I to build our Tribute if we do not have people to build it? Ever
    ...
    <p>
      ...
      he could imagine. It hit him so hard he almost threw the pliers into his
      nose in a reflexive attempt to stop it entering his nose. He resisted,
      barely.
    </p>
    ...
    <p>
      ...
      pulled hard. He heard two cracks as the teeth came out and felt hot blood
      gushing from the open wounds. He pulled back his sleeve to reveal the deep
      knife cut in his arm, and jammed the two teeth into it as hard as he
      could.
    </p>
    ...
    <p>
      “There’s no guarantee you would have. But you did. We chose rightly in
      you.”
    </p>
